...
const { height, width, } = require(path.join(
    basePath,
    "../global_config.json"
));
...
const creators = ["@jalagar_eth"];

const reduceByFraction = (fraction) => ({
    width: parseInt(width * fraction),
    height: parseInt(height * fraction),
});
